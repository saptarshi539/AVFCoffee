...
namespace CoffeeInfrastructure.Flexcel
{
    public class Budget_Sostenemiento
    {
        ...
        public void BudgetSostenemiento(ExcelFile xls)
        {
            ...
            xls.SelectCell(29, 4, false);
            xls.ScrollWindow(25, 1);
