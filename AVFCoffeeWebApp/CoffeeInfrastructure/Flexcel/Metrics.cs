...
namespace CoffeeInfrastructure.Flexcel
{
    ...
    {
        public void metrics(ExcelFile xls, MetricsDTO md)
        {
            ...
            //xls.SetCellValue(11, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D11,'Metrics English'!D11)"));
            xls.SetCellValue(11, 4, md.coffeemeasurekilograms);
            ...
            //xls.SetCellValue(12, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D12,'Metrics English'!D12)"));
            xls.SetCellValue(12, 4, md.coffeemeasurepounds);
            ...
            //xls.SetCellValue(13, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D13,'Metrics English'!D13)"));
            xls.SetCellValue(13, 4, md.coffeemeasurequintales);
            ...
            //xls.SetCellValue(14, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D14,'Metrics English'!D14)"));
            xls.SetCellValue(14, 4, md.coffeemeasurearrobas);
            ...
            //xls.SetCellValue(15, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D15,'Metrics English'!D15)"));
            xls.SetCellValue(15, 4, md.coffeemeasurecargas);
            ...
            //xls.SetCellValue(18, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D18,'Metrics English'!D18)"));
            xls.SetCellValue(18, 4, md.lengthmeasuremeters);
            ...
            //xls.SetCellValue(19, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D19,'Metrics English'!D19)"));
            xls.SetCellValue(19, 4, md.lengthmeasurefeet);
            ...
            xls.SetCellValue(22, 4, md.farmareameasurehectares);
            ...
            xls.SetCellValue(23, 4, md.farmareameasuremanzanas);
            ...
            //xls.SetCellValue(26, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D26,'Metrics English'!D26)"));
            xls.SetCellValue(26, 4, md.applicationmeasurekilograms);
            ...
            //xls.SetCellValue(27, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D27,'Metrics English'!D27)"));
            xls.SetCellValue(27, 4, md.applicationmeasurepounds);
            ...
            //xls.SetCellValue(30, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D30,'Metrics English'!D30)"));
            xls.SetCellValue(30, 4, md.capacitymeasureliters);
            ...
            //xls.SetCellValue(31, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D31,'Metrics English'!D31)"));
            xls.SetCellValue(31, 4, md.capacitymeasuregallons);
            ...
            xls.SetCellValue(34, 4, md.currencyboliviaboliviano);
            ...
            xls.SetCellValue(35, 4, md.currencybrazilreal);
            ...
            //xls.SetCellValue(36, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D36,'Metrics English'!D36)"));
            xls.SetCellValue(36, 4, md.currencycolombiapeso);
            ...
            //xls.SetCellValue(37, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D37,'Metrics English'!D37)"));
            xls.SetCellValue(37, 4, md.currencycostaricacolon);
            ...
            //xls.SetCellValue(38, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D38,'Metrics English'!D38)"));
            xls.SetCellValue(38, 4, md.currencycubapeso);
            ...
            //xls.SetCellValue(39, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D39,'Metrics English'!D39)"));
            xls.SetCellValue(39, 4, md.currencyguatemalaquetzal);
            ...
            //xls.SetCellValue(40, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D40,'Metrics English'!D40)"));
            xls.SetCellValue(40, 4, md.currencyhaitigourde);
            ...
            //xls.SetCellValue(41, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D41,'Metrics English'!D41)"));
            xls.SetCellValue(41, 4, md.currencyhonduraslempira);
            ...
            //xls.SetCellValue(42, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D42,'Metrics English'!D42)"));
            xls.SetCellValue(42, 4, md.currencyjamaicadollar);
            ...
            xls.SetCellValue(43, 4, md.currencymexicopeso);
            ...
            //xls.SetCellValue(44, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D44,'Metrics English'!D44)"));
            xls.SetCellValue(44, 4, md.currencynicaraguacordoba);
            ...
            //xls.SetCellValue(45, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D45,'Metrics English'!D45)"));
            xls.SetCellValue(45, 4, md.currencyperusol);
            ...
            //xls.SetCellValue(46, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D46,'Metrics English'!D46)"));
            xls.SetCellValue(46, 4, md.currencyusdollar);
            ...
            //xls.SetCellValue(47, 4, new TFormula("=IF(Language!$D$6=1,'Metrics Spanish'!D47,'Metrics English'!D47)"));
            xls.SetCellValue(47, 4, md.currencyvenezuelabolivar);
