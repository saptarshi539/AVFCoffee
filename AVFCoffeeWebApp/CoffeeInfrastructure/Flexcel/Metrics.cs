...
namespace CoffeeInfrastructure.Flexcel
{
    ...
    {
        public void metrics(ExcelFile xls)
        {
            ...
            xls.SetColWidth(5, 16384, 2773);    //(10.08 + 0.75) * 256

            xls.SetRowHeight(2, 320);    //16.00 * 20
            xls.SetRowHeight(3, 360);    //18.00 * 20
            xls.SetRowHeight(10, 360);    //18.00 * 20
            xls.SetRowHeight(12, 360);    //18.00 * 20
            xls.SetRowHeight(47, 320);    //16.00 * 20
