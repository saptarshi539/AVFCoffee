...
public class AdvancedInputs
{
    ...
    public void Budget_Supuestos(ExcelFile xls)
    {
        ...
        //We could also have used: xls.SetCellFromHtml(48, 1, "Cual fue el precio por QUINTAL<font color = 'red'>&nbsp;</font>de&nbsp;<b>caf&eacute;"
        ...
        xls.SetCellValue(279, 4, "Se dejan permanentemente insumos organicos durante el mantenimiento, regardless if"
        + " is organic or chemical");
