...
namespace CoffeeInfrastructure.Flexcel
{
    public class Budget_Establecimiento
    {
        ...
        public void BudgetEstablecimiento(ExcelFile xls)
        {
            ...
            xls.SetRowHeight(19, 1575);    //78.75 * 20
            xls.SetRowHeight(27, 1890);    //94.50 * 20
            xls.SetRowHeight(34, 375);    //18.75 * 20
            xls.SetRowHeight(36, 375);    //18.75 * 20
            xls.SetRowHeight(37, 1890);    //94.50 * 20
            xls.SetRowHeight(39, 1215);    //60.75 * 20
            xls.SetRowHeight(40, 615);    //30.75 * 20
            xls.SetRowHeight(41, 615);    //30.75 * 20
            xls.SetRowHeight(42, 915);    //45.75 * 20
            xls.SetRowHeight(43, 615);    //30.75 * 20
            xls.SetRowHeight(49, 2205);    //110.25 * 20
            xls.SetRowHeight(50, 2520);    //126.00 * 20
            xls.SetRowHeight(51, 375);    //18.75 * 20
            xls.SetRowHeight(55, 375);    //18.75 * 20
            xls.SetRowHeight(56, 1260);    //63.00 * 20
            xls.SetRowHeight(58, 2205);    //110.25 * 20
            xls.SetRowHeight(59, 615);    //30.75 * 20
            xls.SetRowHeight(60, 615);    //30.75 * 20
            xls.SetRowHeight(61, 915);    //45.75 * 20
            xls.SetRowHeight(62, 615);    //30.75 * 20
            xls.SetRowHeight(67, 945);    //47.25 * 20
            xls.SetRowHeight(68, 945);    //47.25 * 20
            xls.SetRowHeight(69, 375);    //18.75 * 20
            xls.SetRowHeight(94, 2115);    //105.75 * 20
            xls.SetRowHeight(95, 3915);    //195.75 * 20
            ...
            xls.SetCellValue(4, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Valor de M Obra'!$B$11"));
            ...
            xls.SetCellValue(6, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A232"));
            ...
            xls.SetCellValue(6, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B232"));
            ...
            xls.SetCellValue(7, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A233"));

            fmt = xls.GetCellVisibleFormatDef(7, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(7, 2, xls.AddFormat(fmt));
            xls.SetCellValue(7, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B233"));
            ...
            xls.SetCellValue(7, 8, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Valor de M Obra'!B8+'[Coffee"
            + " Interactive Tool 2.0  06_12_18.xlsx]Budget_Valor de M Obra'!B9"));
            xls.SetCellValue(7, 12, new TFormula("=H7"));

            fmt = xls.GetCellVisibleFormatDef(8, 1);
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(8, 1, xls.AddFormat(fmt));
            xls.SetCellValue(8, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A234"));

            fmt = xls.GetCellVisibleFormatDef(8, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(8, 2, xls.AddFormat(fmt));
            xls.SetCellValue(8, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B234"));
            ...
            xls.SetCellValue(9, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A235"));

            fmt = xls.GetCellVisibleFormatDef(9, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(9, 2, xls.AddFormat(fmt));
            xls.SetCellValue(9, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B235"));
            ...
            xls.SetCellValue(10, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A236"));

            fmt = xls.GetCellVisibleFormatDef(10, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(10, 2, xls.AddFormat(fmt));
            xls.SetCellValue(10, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B236"));
            ...
            xls.SetCellValue(11, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A237"));

            fmt = xls.GetCellVisibleFormatDef(11, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(11, 2, xls.AddFormat(fmt));
            xls.SetCellValue(11, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B237"));

            fmt = xls.GetCellVisibleFormatDef(12, 1);
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(12, 1, xls.AddFormat(fmt));
            xls.SetCellValue(12, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A238"));

            fmt = xls.GetCellVisibleFormatDef(12, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(12, 2, xls.AddFormat(fmt));
            xls.SetCellValue(12, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B238"));
            ...
            xls.SetCellValue(17, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Valor de M Obra'!$B$23"));
            ...
            xls.SetCellValue(19, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A241"));
            ...
            xls.SetCellValue(19, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B241"));

            fmt = xls.GetCellVisibleFormatDef(20, 1);
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(20, 1, xls.AddFormat(fmt));
            xls.SetCellValue(20, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A242"));

            fmt = xls.GetCellVisibleFormatDef(20, 2);
            fmt.Font.Color = TExcelColor.FromTheme(TThemeColor.Accent6, -0.249977111117893);
            fmt.Format = "#,##0";
            xls.SetCellFormat(20, 2, xls.AddFormat(fmt));
            xls.SetCellValue(20, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B242"));
            xls.SetCellValue(20, 3, "6000 bolsitas");
            xls.SetCellValue(20, 4, "Mano obra construccion vivero");
            xls.SetCellValue(20, 8, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Valor de M Obra'!B13"));
            ...
            xls.SetCellValue(21, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A243"));

            fmt = xls.GetCellVisibleFormatDef(21, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(21, 2, xls.AddFormat(fmt));
            xls.SetCellValue(21, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B243"));
            ...
            xls.SetCellValue(22, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A244"));

            fmt = xls.GetCellVisibleFormatDef(22, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(22, 2, xls.AddFormat(fmt));
            xls.SetCellValue(22, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B244"));
            ...
            xls.SetCellValue(23, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A245"));

            fmt = xls.GetCellVisibleFormatDef(23, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(23, 2, xls.AddFormat(fmt));
            xls.SetCellValue(23, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B245"));
            ...
            xls.SetCellValue(24, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A246"));

            fmt = xls.GetCellVisibleFormatDef(24, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(24, 2, xls.AddFormat(fmt));
            xls.SetCellValue(24, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B246"));

            fmt = xls.GetCellVisibleFormatDef(25, 1);
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(25, 1, xls.AddFormat(fmt));
            xls.SetCellValue(25, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A247"));

            fmt = xls.GetCellVisibleFormatDef(25, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(25, 2, xls.AddFormat(fmt));
            xls.SetCellValue(25, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B247"));
            ...
            xls.SetCellValue(26, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A248"));

            fmt = xls.GetCellVisibleFormatDef(26, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(26, 2, xls.AddFormat(fmt));
            xls.SetCellValue(26, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B248"));
            ...
            xls.SetCellValue(27, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A249"));

            fmt = xls.GetCellVisibleFormatDef(27, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(27, 2, xls.AddFormat(fmt));
            xls.SetCellValue(27, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B249"));

            fmt = xls.GetCellVisibleFormatDef(28, 1);
            fmt.Font.Color = TExcelColor.Automatic;
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(28, 1, xls.AddFormat(fmt));
            xls.SetCellValue(28, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A250"));

            fmt = xls.GetCellVisibleFormatDef(28, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(28, 2, xls.AddFormat(fmt));
            xls.SetCellValue(28, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B250"));

            fmt = xls.GetCellVisibleFormatDef(29, 1);
            fmt.Font.Color = TExcelColor.Automatic;
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(29, 1, xls.AddFormat(fmt));
            xls.SetCellValue(29, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A251"));

            fmt = xls.GetCellVisibleFormatDef(29, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(29, 2, xls.AddFormat(fmt));
            xls.SetCellValue(29, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B251"));

            fmt = xls.GetCellVisibleFormatDef(30, 1);
            fmt.Font.Color = TExcelColor.Automatic;
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(30, 1, xls.AddFormat(fmt));
            xls.SetCellValue(30, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A252"));

            fmt = xls.GetCellVisibleFormatDef(30, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(30, 2, xls.AddFormat(fmt));
            xls.SetCellValue(30, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B252"));

            fmt = xls.GetCellVisibleFormatDef(31, 1);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.HAlignment = THFlxAlignment.right;
            xls.SetCellFormat(31, 1, xls.AddFormat(fmt));
            xls.SetCellValue(31, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A253"));

            fmt = xls.GetCellVisibleFormatDef(31, 2);
            fmt.Font.Color = TUIColor.FromArgb(0x00, 0x00, 0xFF);
            fmt.Format = "#,##0";
            xls.SetCellFormat(31, 2, xls.AddFormat(fmt));
            xls.SetCellValue(31, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B253"));
            ...
            xls.SetCellValue(37, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Valor de M Obra'!$B$36"));
            ...
            xls.SetCellValue(39, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B256"));
            ...
            xls.SetCellValue(40, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B257"));
            ...
            xls.SetCellValue(41, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B258"));
            ...
            xls.SetCellValue(42, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B259"));
            ...
            xls.SetCellValue(43, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B260"));
            ...
            xls.SetCellValue(44, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B261"));
            ...
            xls.SetCellValue(45, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B262"));
            ...
            xls.SetCellValue(46, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B263"));
            ...
            xls.SetCellValue(47, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!$B$264"));
            ...
            xls.SetCellValue(56, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Valor de M Obra'!$C$45"));
            ...
            xls.SetCellValue(58, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B266"));
            ...
            xls.SetCellValue(59, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B267"));
            ...
            xls.SetCellValue(60, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B268"));
            ...
            xls.SetCellValue(61, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B269"));
            ...
            xls.SetCellValue(62, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B270"));
            ...
            xls.SetCellValue(63, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B271"));
            ...
            xls.SetCellValue(64, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B272"));
            ...
            xls.SetCellValue(65, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B273"));
            ...
            xls.SetCellValue(66, 2, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!$B$274"));
            ...
            xls.SetCellValue(76, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A355"));
            ...
            xls.SetCellValue(76, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B355"));
            xls.SetCellValue(77, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A356"));
            ...
            xls.SetCellValue(77, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B356"));
            xls.SetCellValue(78, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A357"));
            ...
            xls.SetCellValue(78, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B357"));
            xls.SetCellValue(79, 1, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!A358"));
            ...
            xls.SetCellValue(79, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B358"));
            ...
            xls.SetCellValue(82, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B360"));
            ...
            xls.SetCellValue(83, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B361"));
            ...
            xls.SetCellValue(84, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B362"));
            ...
            xls.SetCellValue(87, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B364"));
            ...
            xls.SetCellValue(88, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B365"));
            ...
            xls.SetCellValue(89, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B366"));
            ...
            xls.SetCellValue(90, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B367"));
            ...
            xls.SetCellValue(93, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B369"));
            ...
            xls.SetCellValue(94, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B370"));
            ...
            xls.SetCellValue(95, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B372"));
            ...
            xls.SetCellValue(96, 6, new TFormula("='[Coffee Interactive Tool 2.0  06_12_18.xlsx]Budget_Supuestos'!B373"));
