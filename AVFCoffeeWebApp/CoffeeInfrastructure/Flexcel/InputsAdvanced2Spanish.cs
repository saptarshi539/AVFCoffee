...
namespace CoffeeInfrastructure.Flexcel
{
    ...
    {
        public Dictionary<string, object> InputAdvancedSpanish(ExcelFile xls, string Language)
        {
            ...
            xls.SetCellValue(168, 2, "Equipo y material reutilizable");
            ...
            if (Language == "ES")
            {
                ...
                dictAdvInputs.Add("Labordesc", xls.GetCellValue(6, 2).ToString() + xls.GetCellValue(7, 2).ToString() +
                    xls.GetCellValue(8, 2).ToString() + xls.GetCellValue(9, 2).ToString() + xls.GetCellValue(10, 2).ToString());
