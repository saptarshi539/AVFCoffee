...
namespace CoffeeInfrastructure.Flexcel
{
    public class Fixed2
    {
        public void Fixed(ExcelFile xls)
        {
            ...
            xls.SetColWidth(10, 10, 2784);    //(10.13 + 0.75) * 256
            ...
            xls.SetColWidth(12, 13, 2784);    //(10.13 + 0.75) * 256

            xls.SetColWidth(14, 14, 4704);    //(17.63 + 0.75) * 256

            xls.SetColWidth(15, 16384, 2784);    //(10.13 + 0.75) * 256
            xls.DefaultRowHeight = 375;

            xls.SetRowHeight(1, 390);    //19.50 * 20
            xls.SetRowHeight(3, 390);    //19.50 * 20
            xls.SetRowHeight(15, 390);    //19.50 * 20

            //Merged Cells
            xls.MergeCells(4, 3, 4, 4);
            xls.MergeCells(4, 5, 4, 7);
            xls.MergeCells(4, 8, 4, 9);
            xls.MergeCells(2, 2, 3, 10);
            ...
            xls.SetCellValue(2, 2, "Fixed Costs");
            ...
            xls.SetCellValue(7, 2, "Fixed Costs");
            ...
            xls.SetCellValue(7, 10, new TFormula("=J8+J15"));
            ...
            xls.SetCellValue(7, 14, "Note for Rishi");
            ...
            xls.SetCellValue(8, 3, new TFormula("=Budget_Presupuesto!D39"));
            ...
            xls.SetCellValue(8, 4, new TFormula("=Budget_Presupuesto!E39"));
            ...
            xls.SetCellValue(8, 5, new TFormula("=Budget_Presupuesto!F39"));
            ...
            xls.SetCellValue(8, 6, new TFormula("=Budget_Presupuesto!G39"));
            ...
            xls.SetCellValue(8, 7, new TFormula("=Budget_Presupuesto!H39"));
            ...
            xls.SetCellValue(8, 8, new TFormula("=Budget_Presupuesto!I39"));
            ...
            xls.SetCellValue(8, 9, new TFormula("=Budget_Presupuesto!J39"));
            ...
            xls.SetCellValue(8, 10, new TFormula("='Outcome_L Adjustment'!$C$3"));
            ...
            xls.SetCellValue(8, 14, "Display order");
            ...
            xls.SetCellValue(9, 3, new TFormula("=Budget_Presupuesto!D39"));
            ...
            xls.SetCellValue(9, 4, new TFormula("=Budget_Presupuesto!E39"));
            ...
            xls.SetCellValue(9, 5, new TFormula("=Budget_Presupuesto!F39"));
            ...
            xls.SetCellValue(9, 6, new TFormula("=Budget_Presupuesto!G39"));
            ...
            xls.SetCellValue(9, 7, new TFormula("=Budget_Presupuesto!H39"));
            ...
            xls.SetCellValue(9, 8, new TFormula("=Budget_Presupuesto!I39"));
            ...
            xls.SetCellValue(9, 9, new TFormula("=Budget_Presupuesto!J39"));
            ...
            xls.SetCellValue(9, 10, new TFormula("=Budget_Presupuesto!K39"));
            ...
            xls.SetCellValue(9, 14, "Fist level");
            ...
            xls.SetCellValue(10, 2, "Personal Income");
            ...
            xls.SetCellValue(10, 3, new TFormula("=Budget_Sostenemiento!D4"));
            ...
            xls.SetCellValue(10, 4, new TFormula("=Budget_Sostenemiento!E4"));
            ...
            xls.SetCellValue(10, 5, new TFormula("=Budget_Sostenemiento!F4"));
            ...
            xls.SetCellValue(10, 6, new TFormula("=Budget_Sostenemiento!G4"));
            ...
            xls.SetCellValue(10, 7, new TFormula("=Budget_Sostenemiento!H4"));
            ...
            xls.SetCellValue(10, 8, new TFormula("=Budget_Sostenemiento!I4"));
            ...
            xls.SetCellValue(10, 9, new TFormula("=Budget_Sostenemiento!J4"));
            ...
            xls.SetCellValue(10, 14, "Second level");
            ...
            xls.SetCellValue(11, 14, "Third level");
            ...
            xls.SetCellValue(12, 2, "Transfers from abroad");
            ...
            xls.SetCellValue(12, 14, "Fourth level");
            ...
            xls.SetCellValue(13, 2, "Coffee activity");
            ...
            xls.SetCellValue(13, 3, new TFormula("=Budget_Sostenemiento!D25"));
            ...
            xls.SetCellValue(13, 4, new TFormula("=Budget_Sostenemiento!E25"));
            ...
            xls.SetCellValue(13, 5, new TFormula("=Budget_Sostenemiento!F25"));
            ...
            xls.SetCellValue(13, 6, new TFormula("=Budget_Sostenemiento!G25"));
            ...
            xls.SetCellValue(13, 7, new TFormula("=Budget_Sostenemiento!H25"));
            ...
            xls.SetCellValue(13, 8, new TFormula("=Budget_Sostenemiento!I25"));
            ...
            xls.SetCellValue(13, 9, new TFormula("=Budget_Sostenemiento!J25"));
            ...
            xls.SetCellValue(13, 14, "Fifth level");
            ...
            xls.SetCellValue(14, 2, "Indirect");
            ...
            xls.SetCellValue(14, 10, new TFormula("=Budget_Presupuesto!K40"));
            ...
            xls.SetCellValue(14, 14, "Sixth level");
            ...
            xls.SetCellValue(15, 2, "Cooperative Membership");
            ...
            xls.SetCellValue(15, 10, new TFormula("=Outcome_Y_Adjustment!I7-'Outcome_L Adjustment'!I3"));
