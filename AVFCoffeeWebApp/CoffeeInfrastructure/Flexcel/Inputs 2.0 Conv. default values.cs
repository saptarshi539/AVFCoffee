...
namespace CoffeeInfrastructure.Flexcel
{
    public class Inputs_2
    {
        public void Inputs_2_Default(ExcelFile xls)
        {
            ...
            xls.SetColWidth(3, 3, 4650);    //(17.41 + 0.75) * 256

            xls.SetColWidth(4, 7, 2773);    //(10.08 + 0.75) * 256
            ...
            xls.SetRowHeight(40, 320);    //16.00 * 20
            ...
            xls.SetRowHeight(154, 360);    //18.00 * 20
            ...
            CommentProps.Anchor = new TClientAnchor(TFlxAnchorType.DontMoveAndDontResize, 9, 128, 1, 0, 24, 38, 1, 0);
