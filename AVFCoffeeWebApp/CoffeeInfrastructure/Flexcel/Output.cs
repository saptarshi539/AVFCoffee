...
namespace CoffeeInfrastructure.Flexcel
{
    public class Output
    {
        public ChartDataDTO Outcome(ExcelFile xls, TWorkspace workspace)
        {
            ...
            producerOutputEnglishDTO.variableCostsUSPound = p1;
            producerOutputEnglishDTO.fixedCostsUSPound = p2;
            producerOutputEnglishDTO.totalCostAndDeprUSPound = p3;
            producerOutputEnglishDTO.totalCostsUSPound = p4;
            producerOutputEnglishDTO.breakEvenCostUSPound = blue;
            producerOutputSpanishDTO.variableCostsUSHect = cp;
            producerOutputSpanishDTO.variableCostsSolesHect = cps;
