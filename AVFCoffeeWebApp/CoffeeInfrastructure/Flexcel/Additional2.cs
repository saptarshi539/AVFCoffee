...
namespace CoffeeInfrastructure.Flexcel
{
    ...
    {
        public void Additional(ExcelFile xls)
        {
            ...
            xls.SetColWidth(3, 3, 13600);    //(52.38 + 0.75) * 256

            xls.SetColWidth(4, 10, 2208);    //(7.88 + 0.75) * 256

            xls.SetColWidth(11, 11, 2784);    //(10.13 + 0.75) * 256

            xls.SetColWidth(12, 12, 1376);    //(4.63 + 0.75) * 256
            ...
            xls.SetColWidth(13, 14, 2784);    //(10.13 + 0.75) * 256

            xls.SetColWidth(15, 15, 5632);    //(21.25 + 0.75) * 256

            xls.SetColWidth(16, 16384, 2784);    //(10.13 + 0.75) * 256
            xls.DefaultRowHeight = 375;

            xls.SetRowHeight(8, 390);    //19.50 * 20
            xls.SetRowHeight(10, 390);    //19.50 * 20
            xls.SetRowHeight(18, 390);    //19.50 * 20

            //Merged Cells
            xls.MergeCells(11, 4, 11, 5);
            xls.MergeCells(11, 6, 11, 8);
            xls.MergeCells(11, 9, 11, 10);
            xls.MergeCells(9, 3, 10, 11);
            ...
            xls.SetCellValue(9, 3, "Additional Costs");
            ...
            xls.SetCellValue(11, 11, "Average");
            ...
            xls.SetCellValue(11, 15, "Note for Rishi");
            ...
            xls.SetCellValue(12, 15, "Display order");
            ...
            xls.SetCellValue(13, 15, "Fist level");
            ...
            xls.SetCellValue(14, 3, "Additional costs");
            ...
            xls.SetCellValue(14, 11, new TFormula("=K15+K18"));
            ...
            xls.SetCellValue(14, 15, "Second level");
            ...
            xls.SetCellValue(15, 3, "Opportunity costs");
            ...
            xls.SetCellValue(15, 4, new TFormula("=Budget_Presupuesto!D39"));
            ...
            xls.SetCellValue(15, 5, new TFormula("=Budget_Presupuesto!E39"));
            ...
            xls.SetCellValue(15, 6, new TFormula("=Budget_Presupuesto!F39"));
            ...
            xls.SetCellValue(15, 7, new TFormula("=Budget_Presupuesto!G39"));
            ...
            xls.SetCellValue(15, 8, new TFormula("=Budget_Presupuesto!H39"));
            ...
            xls.SetCellValue(15, 9, new TFormula("=Budget_Presupuesto!I39"));
            ...
            xls.SetCellValue(15, 10, new TFormula("=Budget_Presupuesto!J39"));
            ...
            xls.SetCellValue(15, 11, new TFormula("='Outcome_L Adjustment'!$C$3"));
            ...
            xls.SetCellValue(15, 15, "Third level");
            ...
            xls.SetCellValue(16, 11, new TFormula("=Budget_Presupuesto!K43"));
            ...
            xls.SetCellValue(16, 15, "Fourth level");
            ...
            xls.SetCellValue(17, 3, "Equipment");
            ...
            xls.SetCellValue(17, 11, new TFormula("=Budget_Presupuesto!K44"));
            ...
            xls.SetCellValue(17, 15, "Fifth level");
            ...
            xls.SetCellValue(18, 3, "Amortized establisment costs");
            ...
            xls.SetCellValue(18, 11, new TFormula("=Outcome_Y_Adjustment!I7-'Outcome_L Adjustment'!I3"));
            ...
            xls.SetCellValue(18, 15, "Sixth level");

            //Cell selection and scroll position.
            xls.SelectCell(33, 11, false);
            xls.ScrollWindow(5, 3);
