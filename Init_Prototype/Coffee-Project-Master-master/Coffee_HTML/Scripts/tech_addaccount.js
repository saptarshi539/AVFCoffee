...
//		var currentPath = window.location.pathname.split('/').slice(1, -1).join('/');
      ...
      //  var currentPath = window.location.pathname
        var placeToGo = currentPath + '/' + 'techall.html';
...
function collectData(){
	...
	var resultJSON = {'name':names,'youngTrees':youngTrees, 'matureTrees':matureTrees, 'oldTrees':oldTrees, 'farmingMethod':farmingMethod, 'workerPay':workerPay, 'productivity':productivity}
